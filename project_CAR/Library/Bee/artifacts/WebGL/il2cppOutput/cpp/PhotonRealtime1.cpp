...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool PingHttp_StartPing_m57D607C08F9030AE8580E82B5F08695166ACE295 (PingHttp_t8AB1B824BE0A03F03FB280EA8C6D599A2D37B87F* __this, String_t* ___address0, const RuntimeMethod* method) 
{
	...
	bool V_1 = false;
	{
		...
		int32_t L_1;
		L_1 = Random_Range_mD4D2DEE3D2E75D07740C9A6F93B3088B03BBB8F8(0, ((int32_t)10000), NULL);
		V_0 = L_1;
		String_t* L_2;
		L_2 = Int32_ToString_m030E01C24E294D6762FB0B6F37CB541581F55CA5((&V_0), NULL);
		String_t* L_3;
		L_3 = String_Concat_mF8B69BE42B5C5ABCAD3C176FBBE3010E0815D65D(_stringLiteralA493FF06F94D0907E2F1797D03C4EB68CE5751F2, L_0, _stringLiteral3194501B3070D667196FEC36634A16DCA641B35A, L_2, NULL);
		___address0 = L_3;
...
IL_0029:
	{
		...
		L_14 = MonoBehaviourEmpty_get_Instance_mD83D68AA1CC43A3D3F45B08971984D715F308AAC(NULL);
		RuntimeObject* L_15;
...
IL_0061:
		{
			...
			Debug_WriteLine_m7EB96D9F52E9424E48A1FAB9D6B6047002B7E7FB(L_26, NULL);
			IL2CPP_POP_ACTIVE_EXCEPTION();
			goto IL_0094;
		}
	}// end catch (depth: 1)
